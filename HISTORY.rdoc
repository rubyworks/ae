...
A quick step up to version 1.8, this release adds a new message system
to allow common assertions have more forensic output.

Changes:

* Add Message module to house custom messages.
