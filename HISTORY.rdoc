...
This new relase improves support for Proc-based assertions and
RSpec-style matchers. This release also finally gets the optional
Check Ok/No library in a usable state. Also the build configuration
has been brough up to date.
...
Quick release fixes an issue due to Ruby 1.9+'s constant lookup
