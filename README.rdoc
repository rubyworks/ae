...
And so forth. In fact, any method can be used in conjunction
with assert to make an assertion.
...
The Download the tarball package from GitHub (under pack/ directory)
and do:
