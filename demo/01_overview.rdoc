...
AE has adopted the shortened term for my fingers sake.)

As mentioned above the +Assertor+ class is a type
of Functor, or Higher-Order function, which intercedes
with a normal message invocation to monitor for failed
conditions, upon which is raises Assertion exceptions.
